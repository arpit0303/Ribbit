...
import com.jaaga.ribbit.RibbitApplication;
import com.jaaga.ribbit.R.id;
import com.jaaga.ribbit.R.layout;
import com.jaaga.ribbit.R.string;
				...
				if(username.isEmpty() || password.isEmpty() || email.isEmpty()){
					...
					newuser.signUpInBackground(new SignUpCallback() {
						...
						public void done(ParseException e) {
							...
							if(e == null){
								//success!
								RibbitApplication.updatePasreInstallation(ParseUser.getCurrentUser());
